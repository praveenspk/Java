...
public class MagicSquare {
	...
	public static void main(String[] args) throws IOException {
		...
		// int[][] s = { { 8, 3, 4 }, { 1, 5, 9 }, { 6, 7, 2 } };
		// This took three replacements at a cost of |5-8|+|8-9|+|4-7|=7
		// int[][] s = { { 5, 3, 4 }, { 1, 5, 8 }, { 6, 4, 2 } };
		// This took three replacements at a cost of |5-6|=1
		int[][] s = { { 4, 9, 2 }, { 3, 5, 7 }, { 8, 1, 5 } };

		/*
		 * for (int i = 0; i < 3; i++) { String[] sRowItems =
		 * scanner.nextLine().split(" ");
		 * scanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");
		 * 
		 * for (int j = 0; j < 3; j++) { int sItem = Integer.parseInt(sRowItems[j]);
		 * s[i][j] = sItem; } }
		 */
