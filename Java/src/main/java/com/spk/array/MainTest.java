...
public class MainTest {
	 ...
	 * stub Employee[] emp = new Employee[2]; emp[0] = new Employee(84119411,
	 * "Praveen", "Kumar", new Department(1, "GSC")); emp[1] = new
	 * Employee(84119423, "Suresh", "Thimothy", new Department(2, "GNOC"));
	 * System.out.println(emp[0].getDepartment() + "\n" + emp[1]); Employee[]
	 * copiedArray = SerializationUtils.clone(emp); emp[0].setFirstName("Huawei");
