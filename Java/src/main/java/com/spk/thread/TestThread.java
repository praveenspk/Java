 ...
 * 
 * class PrintDemo implements Callable<Object> { public void printCount() { try
 * { for (int i = 5; i > 0; i--) { System.out.println("Counter   ---   " + i); }
 * } catch (Exception e) { System.out.println("Thread  interrupted."); } }
 * 
 * @Override public Object call() throws Exception { // TODO Auto-generated
 * method stub return null; } }
 * 
 * class ThreadDemo extends Thread { private Thread t; private String
 * threadName; PrintDemo PD;
 * 
 ...
 * T1.start(); T2.start();
 * 
 * // wait for threads to end try { T1.join(); T2.join(); } catch (Exception e)
